...
import os
import sys
sys.path.insert (0, "C:\Users\Maritimus\Desktop\GoogLeNet model 2\module")
...
# 세이브 파일을 저장할 경로
save_path = "C:\Users\Maritimus\Desktop\GoogLeNet model 2"
...
# Graph Sumaary
# 50 Epoch, lr = 0.001
# 75 Epoch, lr = 0.001 * 0.5
# 100 Epoch, lr = 0.001 * 0.5 * 0.5
...
#     왜냐하면 50Epc 근처에서부터 학습이 급격히 안정화되는걸 관찰했었거든요.
    for Epoch in range (Epochs):
        ...
        # Epoch 51회부터 75회까지는 lr = 0.001*0.75값인 0.00075로 학습할꺼에요.
            ...
            for i in range (390):
                ...
                # LossTraining1 or LossTraining2 or LossTraining3
        ...
        # Epoch 75회부터 끝까지는 lr = 0.001*0.5의 값인 0.00050로 학습할꺼에요.
        else:
...
#         자, 이 라인까지 내려왔다면 한 Epoch 학습이 끝난거에요. 정밀한 추적을 위해 Epoch마다의 Acc를 계산할꺼에요.
